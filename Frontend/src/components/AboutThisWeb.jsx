...
const developerImage = man; // Replace with actual developer image URL
const contributorImage = man; // Replace with actual contributor image URL
const developerLinkedIn = "https://www.linkedin.com/in/developer-profile"; // Replace with actual LinkedIn profile URL
const developerGitHub = "https://github.com/developer-profile"; // Replace with actual GitHub profile URL
const developerLeetCode = "https://leetcode.com/developer-profile"; // Replace with actual LeetCode profile URL
const contributorLinkedIn = "https://www.linkedin.com/in/contributor-profile"; // Replace with actual LinkedIn profile URL
      ...
      <div className="about-page container mx-auto py-16 px-6">
        ...
        <section className="about-section flex flex-col md:flex-row items-center justify-between mb-16">
          <div className="about-text md:w-1/2 text-center md:text-left order-2 md:order-1">
            ...
            Our developer excels in the MERN stack (MongoDB, Express.js, React, Node.js), Java, and Python, bringing a deep understanding of modern web technologies. Their 2-3 years of graphic design experience enhance their ability to create both functional and visually appealing applications.
            </p>
            <p className="text-lg mb-6">
        ...
        <section className="about-section flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="about-text md:w-1/2 text-center md:text-left">
            <h2 className="text-3xl font-bold mb-4">Content Contributor</h2>
            <p className="text-lg mb-4">
              Our content contributor is a Python developer with a knack for blending technical skills with effective communication and sales. Their diverse expertise ensures that the content is both high-quality and engaging.
            </p>
            <p className="text-lg mb-6">
