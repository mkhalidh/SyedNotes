...
function FoundationalMath() {
  ...
  const sections = [
    {
      title: 'Foundational Math Copy Work',
      pdfs: [
        "https://drive.google.com/uc?export=download&id=1mM-3apssQ_YY3T5FHyFxlPwE6gGuG2F3",
        "https://drive.google.com/uc?export=download&id=1QRVJJEwlz1ZfNeg-G338okEzsUNRDwxf"
        // Add more PDF URLs
      ],
      isDownload: true,
    },
...
export default FoundationalMath;
